## About this project 
- This project is based on [React Starter Kit](https://github.com/kriasoft/react-starter-kit) for a quick start

- It uses [Apollo Client](https://www.apollographql.com/docs/react/) for local state management

- [Material-UI](https://material-ui.com/) was chosen to compose the UI components. 

- The application was built using the mobile first technique and was not optimized for desktop due to the short time I had. You can have a better experience using it on a phone or just simulating a phone in chrome development tools. 
## Getting Started
...
You must provide the PAGARME KEYS into the `.env` file.
```
PAGARME_API_KEY=your api key
PAGARME_RECIPIENT_ID_PLATFORM=your platform recipient id
PAGARME_RECIPIENT_ID_CLIENT_A=your client A recipient id
PAGARME_RECIPIENT_ID_CLIENT_B=your client B recipient id
PAGARME_PLATFORM_PERCENTAGE=15
PAGARME_CLIENT_PERCENTAGE=85
```
